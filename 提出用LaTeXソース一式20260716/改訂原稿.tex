...
Rather, it integrates task execution, face-derived feature extraction, task-event/frame-record timestamp alignment, exported-record landmark summaries, and local CSV/ZIP persistence without raw facial video retention within one browser runtime.
...
The deployment completed all 10 planned sessions and 600 trials.
Of the 600 completed trials, 541 trials (90.2\%) had reaction times between 100 and 1500 ms, exceeding the exploratory 80\% reference level.
...
These results provide limited implementation evidence and design considerations for future Camerala versions, but they do not establish general feasibility, robustness, validity in other settings, validated rPPG accuracy, or psychological/physiological effects.
