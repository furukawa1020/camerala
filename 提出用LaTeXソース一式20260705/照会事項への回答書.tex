...
\textbf{Revision.}
We revised RQ1 to specify concrete operational criteria appropriate to the tested deployment: completion of all 10 planned sessions and 600 trials, retention of at least 80\% of completed trials after applying the study-specific RT range of 100--1500 ms, and successful export of timestamp-linked task-event and face-derived records for all sessions.
The deployment completed all 10 sessions and 600 trials.
After applying the RT range, 541/600 trials (90.2\%) were retained for descriptive analysis, exceeding the exploratory 80\% operational target.
...
\texttt{mean\_quality} is retained only as an implementation/logging description for exported records, not as the primary RQ1 success criterion.

\textbf{Key revised text.}
``RQ1. Under the tested remote psychological/psychophysiological task configuration, did Camerala complete the planned 10-session, 600-trial deployment, retain at least 80\% of completed trials within the study-specific reaction-time range of 0.1--1.5 s, and produce timestamp-linked task-event and face-derived records for all sessions?''

``For RQ1, the study-specific operational criteria were: (1) completion of all 10 planned sessions and 600 trials; (2) retention of at least 80\% of completed trials after applying the reaction-time range of 100--1500 ms; and (3) successful export of timestamp-linked task-event and face-derived records for all sessions. The 80\% threshold was an exploratory criterion used in this study to assess whether most completed trials remained available for descriptive analysis. It was not preregistered, independently validated, or intended as a general feasibility threshold.''
...
Specifically, it discusses the need for task-event/frame-record timestamp alignment, operational landmark-availability criteria, motion and brightness-change records, hardware/browser/camera reporting, environment reporting, and cautious interpretation when raw facial video is not retained.
...
Under these conditions, Camerala completed the planned task deployment, retained 541/600 trials (90.2\%) after the study-specific RT range, and exported timestamp-linked task-event and face-derived records for all sessions.
...
\texttt{mean\_quality} is retained only as an implementation/logging description for exported records: it is the exported-window-level mean of a binary landmark-availability flag, not a continuous MediaPipe confidence score, an indicator of rPPG measurement quality, or evidence of physiological measurement accuracy.
The limitation that no-landmark camera frames are not captured by the normal logging path is also retained.
