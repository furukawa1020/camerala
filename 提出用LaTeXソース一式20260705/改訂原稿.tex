...
\begin{enumerate}
    \item \textbf{Local-first browser-native integration prototype}: A research prototype for remote psychological and psychophysiological task experiments that combines task execution, face-derived feature extraction, timestamp alignment, and local persistence within one browser runtime.
...
\textbf{Camerala} (derived from "Camera" + "Laboratory") is positioned as a local-first, browser-native research prototype for remote psychological and psychophysiological task experiments.
