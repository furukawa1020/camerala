...
They do not establish general feasibility, robustness, deployment validity outside the tested task settings, rPPG accuracy, or psychological/physiological effects.
\end{abstract}
...
The retained data included 541/600 trials after the reaction-time criterion, and all 299 exported windows satisfied the \texttt{mean\_quality} criterion.
These results provide limited implementation evidence and design considerations for future Camerala versions, but they do not establish general feasibility, robustness, deployment validity outside the tested task settings, validated rPPG accuracy, or psychological/physiological effects.
