...
\begin{enumerate}
    ...
    \item \textbf{Exploratory deployment under limited conditions}: An N=1 author-participant deployment in which all planned sessions/trials were completed, 90.2\% of trials remained after the study-specific RT range, and timestamp-linked task-event and face-derived records were exported.
\end{enumerate}
