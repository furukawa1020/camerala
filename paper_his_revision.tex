...
For RQ1, the study-specific operational criteria were completion of all 10 planned sessions and 600 trials, retention of at least 80\% of completed trials after applying the reaction-time range of 100--1500 ms, and successful export of timestamp-linked task-event and face-derived records for all sessions.
...
After applying the study-specific reaction-time range of 100--1500 ms, 541/600 trials (90.2\%) were retained for descriptive analysis, exceeding the exploratory operational target of 80\%.
...
After the study-specific RT range, 541/600 trials (90.2\%) remained, exceeding the exploratory 80\% target; all 299 exported windows had \texttt{mean\_quality} = 1.0 as a descriptive exported-record summary.
