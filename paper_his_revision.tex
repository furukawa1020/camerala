...
The logged \texttt{quality} field was treated as a landmark-availability flag for saved records, not as a continuous confidence value from the face-processing pipeline.
