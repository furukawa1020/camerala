...
Prior work has also examined web-deployable, privacy-oriented, and edge-oriented rPPG systems and tools \cite{ayesha_web_vital,gupta_privacy,rhythmedge,labvanced_rppg,facephys_demo}.
These systems and tools show that browser-based and edge-based rPPG functionality already exists.
Recent work on online webcam rPPG further shows that uncontrolled capture conditions can affect remote heart-rate imaging \cite{di_lernia_rppg_wild}.
...
\subsection{Browser-Based, Edge-Based, and Privacy-Oriented rPPG Systems and Public Tools}
Several prior systems and public tools are directly relevant to Camerala's positioning.
...
Well-established web experiment libraries and experiment runtimes, such as jsPsych \cite{jspsych} and PsychoPy/PsychoJS/Pavlovia \cite{psychopy2}, support browser-based task execution and online experiments.
...
\newblock In {\em Information Integration and Web Intelligence (iiWAS 2022)}, Lecture Notes in Computer Science, vol. 13635, 2022.
...
D. Di~Lernia, G. Finotti, M. Tsakiris, et~al.
...
K. Wang.
\newblock FacePhys-Demo: FacePhys web demo.
\newblock \url{https://github.com/KegangWangCCNU/FacePhys-Demo}, accessed July 5, 2026.

\bibitem{jspsych}
J.~R. de Leeuw.
\newblock jsPsych: A JavaScript library for creating behavioral experiments in a Web browser.
\newblock {\em Behavior Research Methods}, 47(1):1--12, 2015.
