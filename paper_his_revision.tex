...
The intended use case of Camerala is a remote psychological or psychophysiological task experiment conducted in a private or home setting, where the participant sits in front of a laptop, views browser-based task stimuli, and responds through the browser.
...
The target usage scenario is a remote psychological or psychophysiological task experiment in which a participant performs a browser-based task from a private or home setting.
...
The laboratory/home differences observed in this deployment should be interpreted as mixed deployment-context differences.
...
Seventh, the current logs do not store continuous confidence values from the face-processing pipeline for all frames.
