...
these effects were statistically indistinguishable from baseline in the Home environment ($p>0.30$, negligible effect sizes). 
...
we can predict acute stress with high fidelity.
...
A model trained to detect stress in a driving simulator may fail to generalize when applied to a user sitting in their living room, 
