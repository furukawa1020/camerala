...
\textbf{Revision.}
The revised manuscript clarifies that Camerala targets remote psychological and psychophysiological task experiments conducted in private or home settings.
...
We revised the manuscript to define Camerala's target use case as a remote psychological/psychophysiological task experiment conducted in private or home settings, rather than continuous physiological sensing during ordinary daily activities.

\textbf{Revision.}
The revised manuscript now states that the participant is expected to sit in front of a laptop, view browser-based task stimuli, and respond through the browser.
...
The laboratory setting in the present deployment is described as a comparison context, not as the primary target scenario.

\textbf{Key revised text.}
``The intended use case of Camerala is a remote psychological or psychophysiological task experiment conducted in a private or home setting, where the participant sits in front of a laptop, views browser-based task stimuli, and responds through the browser. The goal is not continuous physiological sensing during ordinary daily activities.''
...
The revised manuscript describes the target use case as a remote psychological or psychophysiological task experiment conducted in private or home settings.
It also explicitly states that the deployment is not continuous physiological sensing during ordinary daily activities: the participant sits in front of a laptop, views browser-based task stimuli, and responds through the browser.
The laboratory setting is described as a comparison context in the present exploratory deployment.
