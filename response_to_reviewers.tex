...
We removed confidence-threshold filtering, confidence percentages from the face-processing pipeline, and claims about whether face tracking was available in each frame from the current results.
