...
\textbf{Revision.}
A paragraph was added in the Introduction explaining that local offline processing of recorded video would be possible, but would require storing privacy-sensitive raw video.
The revised text explains that Camerala extracts features during task execution to avoid raw-video persistence and to store synchronized task events, feature records, and quality-related indicators in the same browser runtime.
...
We removed confidence-threshold filtering, tracking-confidence percentages, and face-tracking availability claims from the current results.
The quality field is now described as a landmark-availability flag for saved records, not as continuous tracking confidence.
The RT-based retained-trial count was updated to 541/600 after applying the 100--1500 ms reaction-time criterion.

\textbf{Key revised text.}
``The logged quality field was treated as a landmark-availability flag for saved records, not as a continuous face-detection or tracking-confidence value.''
