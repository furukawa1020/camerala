...
| 3 | Clarify RQ1 and success criteria | Replace RQ1 with concrete operational criteria for the tested deployment: completion of all 10 planned sessions and 600 trials, retention of at least 80% of completed trials after the study-specific RT range of 100--1500 ms, and export of timestamp-linked task-event and face-derived records for all sessions. Keep `mean_quality` only as a descriptive exported-window logging summary, not the main RQ1 criterion. | Quote revised RQ1, the operational-criteria paragraph, the 541/600 (90.2%) RT-retained trials, the exploratory 80% target, and the verified all-session timestamp-linked logging statement. | Drafted |
