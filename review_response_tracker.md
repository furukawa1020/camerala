...
| 5 | Justify novelty and positioning | Discuss reviewer-mentioned web/edge/privacy-oriented rPPG systems; explicitly state novelty is integrated task execution + on-device features + timestamped local logging, not browser rPPG or local rPPG alone. | List added related systems and quote positioning paragraph. | Drafted; no arXiv references |
