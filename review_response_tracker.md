...
| 4 | Define "between-environment differences" in RQ2 | Retain the original RQ2 wording, but clarify immediately after it that "physiological signals" is interpreted conservatively as task-synchronized face-derived and sensor-derived exported records. Keep the Lab/Home comparison, but state that the differences may reflect lighting, screen light, posture, camera geometry, task timing, measurement-pipeline factors, participant state, or their mixture, and are not interpreted as psychological/physiological effects. | Quote the retained RQ2 and the deployment-context interpretation paragraph. | Drafted |
