...
| 3 | Clarify RQ1 and success criteria | Replace RQ1 with tested-configuration wording; define completion, local persistence, synchronized logs, RT retention after the 100--1500 ms criterion, and the window-level landmark-availability criterion of `mean_quality >= 0.8`. | Quote revised RQ1, the 541/600 RT-retained trials, and the result that all 299 exported windows had `mean_quality = 1.0`. | Drafted |
